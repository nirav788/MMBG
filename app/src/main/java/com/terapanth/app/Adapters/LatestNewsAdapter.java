...
import com.terapanth.app.activities.LatestDetailActivity;
...
public class LatestNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LatestNewsAdapter(ArrayList<NewsResponce.News> news, Context mContext, RecyclerView recyclerView) {
        this.mNews = news;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new LatestNewsAdapter.TPRulesAdapterViewHolder(view);

        } else if (viewType == VIEW_TYPE_LOADING) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loading, parent, false);
            return new LatestNewsAdapter.LoadingViewHolder(view);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof LatestNewsAdapter.TPRulesAdapterViewHolder) {

            final LatestNewsAdapter.TPRulesAdapterViewHolder ViewHolders = (LatestNewsAdapter.TPRulesAdapterViewHolder) holder;
        ...
        } else if (holder instanceof LatestNewsAdapter.LoadingViewHolder)

        {
            LatestNewsAdapter.LoadingViewHolder loadingViewHolder = (LatestNewsAdapter.LoadingViewHolder) holder;
