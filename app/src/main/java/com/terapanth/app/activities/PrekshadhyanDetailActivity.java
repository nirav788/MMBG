...
public class PrekshadhyanDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prekshadhyan_detail);
    ...
    private void setData() {
        ...
        if (Description != null && Description.length() > 0) {
            ...
            Glide.with(PrekshadhyanDetailActivity.this).load(Images).into(img_pravachan);
        } else {
    ...
    private void initView() {
        ...
        toolbar_title.setText("Prekshadhyan Detail");
