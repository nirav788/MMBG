...
public class NewsActivity extends AppCompatActivity {
    ...
    private void init() {
        mAppPreference = new AppPreference(NewsActivity.this);
    }
    ...
    private void inItView() {
        ...
        toolbar_title.setText("MMBG News");
    ...
    private void getAllNews(int offset) {
        Utills.showProgressBar(NewsActivity.this, getResources().getString(R.string.pleasewait));
        ApiInterface restInterface = ServiceGeneratorr.createService(ApiInterface.class);
        Call<NewsResponce> call = restInterface.News(offset);
            ...
            public void onResponse(Call<NewsResponce> call, Response<NewsResponce> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (successCode) {
                        ...
                        mAdapter = new NewsAdapter(mNuNews, NewsActivity.this, rv_news);
                        rv_news.setAdapter(mAdapter);
                        ...
                        Utills.setError(NewsActivity.this, userObject.getMessage().toString());
                    }
                } else {
                    Utills.setError(NewsActivity.this, getResources().getString(R.string.server_connection_problem));
                }
            }
