...
public class MahasabhaTeamActivity extends AppCompatActivity {
    ...
    private void init() {
        mAppPreference = new AppPreference(MahasabhaTeamActivity.this);
    }
    ...
    private void onhandleClick() {
        ...
        toolbar_title.setText("MMBG Mahashabha Team");
        ...
        mLayoutManager = new LinearLayoutManager(MahasabhaTeamActivity.this);
    ...
    private void getMahasabhaTeam(int offset) {
        ...
        Utills.showProgressBar(MahasabhaTeamActivity.this, getResources().getString(R.string.pleasewait));
            ...
            public void onResponse(Call<MahasabhateamResponce> call, Response<MahasabhateamResponce> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (successCode) {
                        ...
                        mAdapter = new MahasabhaTeamAdapter(mMahasabhateams, MahasabhaTeamActivity.this, rv_mmbg_team);
                        rv_mmbg_team.setAdapter(mAdapter);
                        ...
                        Utills.setError(MahasabhaTeamActivity.this, userObject.getMessage().toString());
                    }
                } else {
                    Utills.setError(MahasabhaTeamActivity.this, getResources().getString(R.string.server_connection_problem));
                }
            }
