...
/**
 * Created by Developer on 05-04-2018.
 */

public class ManagementResponce {
    ...
    @SerializedName("data")
    @Expose
    ArrayList<Management> mManagement;
    ...
    public ArrayList<Management> getmManagement() {
        return mManagement;
    }

    public void setmManagement(ArrayList<Management> mManagement) {
